        ...
        def check():
            try:
                ...
                if not z:
                    ...
                    #label and input box
                    self.label3 = Label(self, text='Welcome To CHINMAYA\'s Library', bg='orange', font=('Algerian', 45, 'bold'))
                    self.label3.place(x=290, y=80)
                    self.label4 = Label(self, text="Enter Student Id", bg='whitesmoke', font=('Arial', 20, 'bold'))
                    ...
                    self.label5 = Label(self, text='OR', bg='whitesmoke', font=('arial', 16, 'bold')).place(x=170, y=235)
                    self.label5 = Label(self, text="Enter Book Id", bg='whitesmoke', font=('Arial', 20, 'bold'))
                    ...
                    self.label6 = Label(self, text="Details", bg='whitesmoke', font=('Arial', 15, 'underline', 'bold'))
